                ...
                <div classNameName="container align-middle">
                  ...
                  <div className="row">
                    ...
                    <div className="col-lg-8">
                      ...
                      <h2 className="headingLearn">How does Blockchain Voting System works?</h2>
                      ...
                      <div className="containerLearnMore" >
                        ...
                        <br/>
                        <p className="content1">This system is the upcoming way of casting vote where all the votes will be stored in the Blockchain, which
                          makes the system tamper proof and completely transparent.</p>
                      </div>

                      <br/>
                      <div className="containerLearn2 general" role="alert">
                        <span>This system is still under development and various trials! Please expect a few bugs.</span>
                      </div>
                      <br/>
